...
You are required to implement a **distributed application** using
...
* Invoke remote methods from the client
...
* Push complete source code to this repository
* Include execution screenshots or logs
* Code must be well-commented
* Do not upload cloud credentials
